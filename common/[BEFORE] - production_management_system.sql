...
INSERT INTO `pms_rawmaterials` (`pms_id`, `pms_sku`, `pms_item`, `pms_description`, `pms_qty`, `pms_unit`, `pms_type`, `pms_cost`, `pms_wtpc_thickness`, `pms_wtpc_width`, `pms_finishedproduct`, `pms_finishedproduct_code`, `pms_image`, `pms_archive_status`, `pms_type_of_units`, `pms_supplier_name`) VALUES
(1, 'PMS0641', 'Selecta Black Forest', 'Selecta Ice cream', 310, 250, 'Plastics Packaging', '149.00', '10.00', '5.00', 1, 0, 'Selecta black forest.png', 0, 'Gram (g)', 'Baskin Robbins'),
(2, 'PMS0982', 'Selecta Coffee crumble', 'Selecta Ice cream', 140, 250, 'Plastics Packaging', '149.00', '2.00', '15.00', 1, 0, 'Selecta Coffee crumble.png', 0, 'Gram (g)', 'Baskin Robbins'),
(3, 'PMS0362', 'Selecta Chocolate', 'Selecta Ice cream', 200, 500, 'Plastics Packaging', '250.00', '10.00', '20.00', 1, 0, 'Selecta Chocolate.png', 0, '', 'Baskin Robbins'),
(4, 'PMS0148', 'Selecta Caramel cheesecake', 'Selecta Ice cream', 75, 600, 'Plastics Packaging', '349.00', '4.00', '15.00', 1, 0, 'Selecta Caramel cheesecake.png', 0, 'Kilogram (kg)', 'Baskin Robbins'),
(5, 'PMS0163', 'Gallon', 'Used for storing ice cream', 100, 40, 'Flexible Packaging', '150.00', '10.00', '20.00', 0, 0, 'gallon.png', 0, 'Gram (g)', 'Judea'),
(6, 'PMS0869', 'Label', 'Nutrition Facts for Ice cream', 75, 10, 'Flexible Packaging', '50.00', '4.00', '6.00', 0, 0, 'label.png', 0, 'Miligram (mg)', 'Judea'),
(7, 'PMS0485', 'Condensed Milk', 'used for sweetening the product', 30, 60, 'Preservation Packaging', '45.00', '37.00', '45.00', 0, 0, 'Condensed milk.png', 0, 'Gram (g)', 'Judea'),
(8, 'PMS0538', 'Cocoa Powder', 'Used for flavoring ', 40, 1, 'Preservation Packaging', '60.00', '2.00', '7.00', 0, 0, 'cocoa powder.png', 0, 'Kilogram (kg)', 'Judea'),
(9, 'PMS0439', 'Chopped mixed nuts', 'added ingredients for black forest ice cream', 35, 20, 'Plastics Packaging', '75.00', '5.00', '9.00', 0, 0, 'Chopped mixed nuts.png', 0, 'Kilogram (kg)', 'Judea'),
(10, 'PMS0731', 'Marshmallow', 'added ingredient for black forest ice cream', 45, 15, '', '40.00', '10.00', '20.00', 0, 0, 'marshmallow.png', 0, 'Kilogram (kg)', 'Judea'),
(11, 'PMS0213', 'Selecta Mango', 'Selecta Ice cream', 150, 500, 'Plastics Packaging', '250.00', '3.00', '6.00', 1, 1, 'Selecta Mango.png', 0, 'Gram (g)', 'Baskin Robbins'),
(12, 'PMS0413', 'Selecta Strawberry', 'Selecta Ice cream', 125, 500, 'Plastics Packaging', '350.00', '60.00', '20.00', 1, 1, 'Selecta Strawberry.png', 0, 'Kilogram (kg)', 'Baskin Robbins'),
(13, 'PMS0246', 'Chicken Tocino', 'Tocino Product', 80, 1, 'Plastics Packaging', '50.00', '34.00', '20.00', 1, 0, 'Chicken tocino.png', 0, 'Kilogram (kg)', 'Virginia'),
(14, 'PMS0137', 'Gallon', 'Used for storing ice cream', 35, 40, 'Flexible Packaging', '150.00', '12.00', '13.00', 0, 0, 'gallon.png', 0, 'Gram (g)', 'Judea');
...
INSERT INTO `pms_suppliers_product` (`pms_id`, `pms_cat_id`, `pms_suprod_image`, `pms_suprod_itemname`, `pms_suprod_description`, `pms_suprod_unit`, `pms_suprod_typeunit`, `pms_suprod_cost`, `pms_suprod_suppliername`, `pms_suprod_status`, `pms_suprod_finishproduct`, `pms_suprod_quantity`) VALUES
(1, 1, 'Selecta black forest.png', 'Selecta Black Forest', 'Selecta Ice cream', 250, 'Gram (g)', '149.00', 'Baskin Robbins', 0, 1, 1000),
(2, 1, 'Selecta Cookies & cream.png', 'Selecta Cookies & cream', 'Ice cream', 250, 'Gram (g)', '149.00', 'Baskin Robbins', 0, 1, 200),
(3, 1, 'Selecta Cookies & cream.png', 'Selecta Cookies & cream', 'Ice cream', 250, 'Gram (g)', '149.00', 'Baskin Robbins', 1, 1, 200),
(4, 1, 'Selecta Coffee crumble.png', 'Selecta Coffee crumble', 'Selecta Ice cream', 250, 'Gram (g)', '149.00', 'Baskin Robbins', 0, 1, 350),
(5, 1, 'Selecta Chocolate.png', 'Selecta Chocolate', 'Selecta Ice cream', 500, '', '250.00', 'Baskin Robbins', 0, 1, 400),
(6, 1, 'Selecta Caramel cheesecake.png', 'Selecta Caramel cheesecake', 'Selecta Ice cream', 600, 'Kilogram (kg)', '349.00', 'Baskin Robbins', 0, 1, 100),
(7, 1, 'Selecta Strawberry.png', 'Selecta Strawberry', 'Selecta Ice cream', 500, 'Kilogram (kg)', '350.00', 'Baskin Robbins', 0, 1, 150),
(8, 1, 'Selecta Mango.png', 'Selecta Mango', 'Selecta Ice cream', 500, 'Gram (g)', '250.00', 'Baskin Robbins', 0, 1, 245),
(9, 2, 'Chicken tocino.png', 'Chicken Tocino', 'Tocino Product', 1, 'Kilogram (kg)', '50.00', 'Virginia', 0, 1, 150),
(10, 2, 'Hotdog.PNG', 'Hotdog', 'Hotdog Product', 2, 'Kilogram (kg)', '48.00', 'Virginia', 0, 1, 350),
(11, 2, 'Ham.PNG', 'Ham', 'Ham Product', 1, 'Kilogram (kg)', '37.00', 'Virginia', 0, 1, 100),
(12, 2, 'Bacon.PNG', 'Bacon', 'Bacon Product', 1, 'Kilogram (kg)', '350.00', 'Virginia', 0, 1, 150),
(13, 3, 'gallon.png', 'Gallon', 'Used for storing ice cream', 40, 'Gram (g)', '150.00', 'Judea', 0, 0, 200),
(14, 3, 'label.png', 'Label', 'Nutrition Facts for Ice cream', 10, 'Miligram (mg)', '50.00', 'Judea', 0, 0, 200),
(15, 3, 'Condensed milk.png', 'Condensed Milk', 'used for sweetening the product', 60, 'Gram (g)', '45.00', 'Judea', 0, 0, 40),
(16, 3, 'cocoa powder.png', 'Cocoa Powder', 'Used for flavoring ', 1, 'Kilogram (kg)', '60.00', 'Judea', 0, 0, 65),
(17, 3, 'Chopped mixed nuts.png', 'Chopped mixed nuts', 'added ingredients for black forest ice cream', 20, 'Kilogram (kg)', '75.00', 'Judea', 0, 0, 50),
(18, 3, 'marshmallow.png', 'Marshmallow', 'added ingredient for black forest ice cream', 15, 'Kilogram (kg)', '40.00', 'Judea', 0, 0, 50);
...
--
ALTER TABLE `pms_activitylogs`
  MODIFY `pms_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=128;
...
--
ALTER TABLE `pms_suppliers_product`
  MODIFY `pms_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
