...
if ($pms_mode=="addfinishproduct") {
  ...
  $con=mysqli_query($GLOBALS["___mysqli_ston"],
    ...
    '$pms_user',
    NOW(),
    'Added $pms_item (Finished Product)',
    '$pms_usertype'
    )");
   header("Location: pms_finished_product.php");
    }
...
<head>
    ...
    <title>Finished Products | Inventory and Distribution Management System</title>
...
<!-- <div id="myDiv" class="animate-right"> -->
          ...
          <div class="container-fluid">
                  ...
                  <div class="col-12">
                      <div class="card" >
                          <div class="card-body">
                            ...
                            <button
                            onclick="addFinishProduct();"
                            class="btn btn-primary"
                            href="#finishProductModal"
                            data-target="#finishProductModal"
                            style="color:#fff;"
                            >
                            <i class="fa fa-plus"></i> Add New Finished Product(s)
                            </button>
                            &nbsp;
                            <button
                            onclick="archiveListRawMaterials();"
                            class="btn btn-primary"
                            href="#archivefinishProductModal"
                            data-target="#archivefinishProductModal"
                            style="color:#fff;"
                            >
                            <i class="fa fa-list"></i> Archives of Finished Product(s)
                            </button>
                        ...
                        <tbody>
                          ...
                          ?>
                               ...
                               <button onclick="viewRawMaterial('<?php echo $row['pms_id'] ; ?>',
                                            ...
                                            href="#finishProductModal<?php echo $row['pms_id'];?>"
                                ...
                                <button onclick="editFinishProduct('<?php echo $row['pms_id'] ; ?>',
                                            '<?php echo $row['pms_sku'] ?>',
                                            '<?php echo $row['pms_item'] ?>',
                                            '<?php echo $row['pms_supplier_name'] ?>',
                                            '<?php echo $row['pms_description'] ?>',
                                            ...
                                            '<?php echo $row['pms_finishedproduct'] ?>',
                                            '<?php echo $row['pms_image'] ?>',
                                            '<?php echo $row['pms_archive_status'] ?>');"
                                            href="#finishProductModal<?php echo $row['pms_id'];?>"
                                            style="background-color: #3bdb39; color: #ffffff; margin-top: 10px;"
                                            class="btn"><i class="icon-pencil icon-large"> Edit</i></button>
                                &nbsp;
                                <button onclick="archiveFinishProduct('<?php echo $row['pms_id'] ?>');"
                                        id="archiveRawMaterialBtn"
                                        style="background-color: #ba1307; color: #ffffff; margin-top: 10px;"
              ...
              <form method="post">
                 ...
                 <div id="finishProductModal" class="w3-modal">
                 <div class="w3-modal-content" style="margin-top: -80px; margin-left: 400px; width: 700px; height: 1250px;">
                     <div class="w3-container">
                       <br>
                       <center>
                       <h4 class="modal-title"><span id="finishProductModaltitle"></span></h4>
                       </center>
                       <br><br>
                       <span onclick="document.getElementById('finishProductModal').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                      ...
                      <input type="hidden" name="pms_supid" id="pms_supid">
                              ...
                              <center>
                               <img src="images/uploadimage/noimage.png" id="rawmaterialimagesource" width="150px" height="150px" style="border-radius: 25px;">
                                   ...
                                   <div class="form-group" style="width: 850px;">
                                     ...
                                     <div class="col-lg-9">
                                       <input type="text" class="form-control input-focus" id="pms_sku" name="pms_sku" readonly>
                                     </div>
                                   </div>
                       ...
                       <center>
                         <div style="text-align: center;">
                           ...
                           >Save</button>&nbsp;&nbsp;
                           <button id="cancelBtn" type="button" style="border-radius: 20px;" class="btn btn-lg btn-danger" onclick="document.getElementById('finishProductModal').style.display='none'" class="btn btn-default" data-dismiss="modal">Cancel</button>
                 ...
                 <div id="archivefinishProductModal" class="w3-modal">
                 <div class="w3-modal-content" style="margin-top: -70px; margin-left: 100px; width: 1300px;">
                     <div class="w3-container">
                       <br>
                       <center>
                       <h4 class="modal-title"><span id="archivefinishProductModaltitle"></span></h4>
                       </center>
                       <br><br>
                       <span onclick="document.getElementById('archivefinishProductModal').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                       ...
                       <table id="DataTableAssembleList"
                              ...
                              cellspacing="0" >
                                 ...
                                 <tbody>
                                   ...
                                   <?php
                                   $sql_query_header_list = "SELECT * FROM pms_rawmaterials WHERE pms_archive_status = 1 AND pms_finishedproduct = 1";
...
function FetchSupplier(name) {
    ...
    $(document).ready(function(){	
        $.ajax({
            url: 'http://localhost/PMS/8080/pms_get_supplier_fp.php?name=' + name,
            dataType: 'jsonp',
            jsonp: 'pms',
            timeout: 5000,
            success: function(data, status){
                $.each(data, function(i,item){ 
                    if (item.pms_id==undefined){
                        ...
                        var supplier_letter_id = item.pms_suprod_letter_id;
                        ...
                        $("#pms_sku").val("<?php echo $rmrand; ?>" + supplier_letter_id);
                      }                  
                });
            },
            error: function(){
...
//  }
 ...
 {
   document.getElementById('finishProductModal').style.display='block';

       $("#finishProductModaltitle").html("Add Finish Product") ;
       $("#inputstatus").val("addfinishproduct") ;
 ...
 function editFinishProduct(key,sku,item,suppliername,description,qty,unit,typeunit,type,cost,finishedproduct,image,status)
 {
  // alert(item);
       document.getElementById('finishProductModal').style.display='block';
       $("#finishProductModaltitle").html("Edit Raw Material / Products") ;
 ...
 function archiveFinishProduct(arch_pms_id)
 {
 ...
 function confirmArchiveKey(confirmArchive_key)
 {
       ...
       document.getElementById('archivefinishProductModal').style.display='none';
 ...
 function archiveListRawMaterials(){
   ...
   document.getElementById('archivefinishProductModal').style.display='block';
   $("#archivefinishProductModaltitle").html("ARCHIVES OF FINISHED PRODUCTS") ;
 ...
 {
       document.getElementById('finishProductModal').style.display='block';
       $("#finishProductModaltitle").html("View Finished Products") ;
       $("#inputkey").val(key) ;
