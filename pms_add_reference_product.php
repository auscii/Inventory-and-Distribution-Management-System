...
if (isset($_POST["archivestatus"])) {
  ...
  if (isset($_POST["inputstatusrefproduct"])) {
    $inputstatusrefproduct = $_POST['inputstatusrefproduct'];
   } else {
    $inputstatusrefproduct = "";
  }
  
  if (isset($_POST["inputkeyrefproduct"])) {
    $inputkeyrefproduct = $_POST['inputkeyrefproduct'];
   } else {
    $inputkeyrefproduct = "";
  }
  ...
  if (isset($_POST["pms_reference_product_itemname"])) {
    $pms_reference_product_itemname = $_POST['pms_reference_product_itemname'];
   } else {
    $pms_reference_product_itemname = "";
  }

  if (isset($_POST["pms_order_quantity"])) {
    $pms_order_quantity = $_POST['pms_order_quantity'];
   } else {
    $pms_order_quantity = "";
  }
  ...
  if (isset($_POST["pms_typeunit"])) {
    $pms_typeunit = $_POST['pms_typeunit'];
   } else {
    $pms_typeunit = "";
  }

  if (isset($_POST["pms_unit_price"])) {
    $pms_unit_price = $_POST['pms_unit_price'];
   } else {
    $pms_unit_price = "";
  }

  if (isset($_POST["pms_image"])) {
    $pms_image_rp = $_POST['pms_image'];
   } else {
    $pms_image_rp = "";
  }
  ...
  if(isset($_GET["rp_pms_id"])){
    $rp_pms_id = $_GET["rp_pms_id"];
  } else {
    $rp_pms_id = "";
  }

  if(isset($_GET["rp_pms_item"])){
    $rp_pms_item = $_GET["rp_pms_item"];
  } else {
    $rp_pms_item = "";
  }

  if(isset($_GET["rp_pms_unit"])){
    $rp_pms_unit = $_GET["rp_pms_unit"];
  } else {
    $rp_pms_unit = "";
  }

  if(isset($_GET["rp_pms_type_of_units"])){
    $rp_pms_type_of_units = $_GET["rp_pms_type_of_units"];
  } else {
    $rp_pms_type_of_units = "";
  }

  if(isset($_GET["rp_pms_cost"])){
    $rp_pms_cost = $_GET["rp_pms_cost"];
  } else {
    $rp_pms_cost = "";
  }
  ...
  if ($inputstatusrefproduct=="addreferenceproduct") {
    echo '
    <div id="myModal">
      ...
      $con=mysqli_query($GLOBALS["___mysqli_ston"],
        ...
        '$pms_user',
        NOW(),
        'Added $pms_reference_product_itemname (Reference Product)',
        '$pms_usertype'
        )");
    }
  ...
  if ($pms_archivemode=="archiverefprod") {
...
if ($inputstatusrefproduct=="editreferenceproduct") {
echo '
<div id="myModal">
    <div class="modal-dialog" style="margin-left: -50px;">
        <div class="modal-content">
  ...
  $con=mysqli_query($GLOBALS["___mysqli_ston"], 
    "UPDATE pms_referenceproducts
    SET pms_reference_product_itemname='$pms_reference_product_itemname',
        pms_order_quantity='$pms_order_quantity',
        pms_unit='$pms_unit',
        pms_typeunit='$pms_typeunit',
        pms_unit_price='$pms_unit_price',
        pms_image='$pms_image_rp'
    WHERE pms_id = $inputkeyrefproduct");
}
...
<head>
    ...
    <title>Reference Product(s) | Inventory and Distribution Management System</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                  <h3 class="text-primary">Add Reference Product of <?php echo $rp_pms_item; ?></h3> </div>
              <div class="col-md-7 align-self-center">
                  <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="pms_reference_product.php">Reference Product</a></li>
                      <li class="breadcrumb-item active">Add Reference Product</li>
                  </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
      ...
      <div class="row">
          <div class="col-12">
              <div class="card" style="background: #ebefea;">
                ...
                <button onclick="addReferenceProduct();"
                        id="addSupplierBtn"
                        class="btn btn-primary"
                        style="color: #ffffff;"
                        class="btn"><i class="fa fa-plus"> Add Reference Product(s)
                        </i></button>
                ...
                class="btn btn-primary"
                href="#archiveRefProdModal"
                data-target="#archiveRefProdModal"
                style="color:#fff;"
                >
                <i class="fa fa-list"></i> Archives of Reference Product(s)
                </button>

                <?php 
                $sql = mysqli_query($GLOBALS["___mysqli_ston"], 
                "SELECT * FROM pms_referenceproducts WHERE pms_product_item_name = '$rp_pms_item' AND pms_archive_status = 0");
                $count_entry = mysqli_num_rows($sql);
                echo "<p class='text-primary' style='position:absolute; right:10px; top:30px;'>Total Number of Reference Product(s) of $rp_pms_item: $count_entry</p>"; 
                ?>
          ...
          <table id="DataTable1" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Reference Product Name</th>
          ...
          ?>
                                ...
                                <td style="text-align: center; color: #000;"><?php echo $row['pms_reference_product_itemname']; ?></td>

                                <td style="text-align: center; color: #000;"><?php echo $row['pms_order_quantity']; ?></td>
                                
                                <td style="text-align: center; color: #000;"><?php echo $row['pms_unit'] . " " . $row['pms_typeunit']; ?></td>

                                <td style="text-align: center; color: #000;"><?php echo $row['pms_unit_price']; ?></td>

                                <td style="text-align: center; color: #000; width: 200px;">
                                  <button onclick="editreferenceproduct('<?php echo $row['pms_id'] ; ?>',
                                                                '<?php echo $row['pms_image'] ; ?>',
                                                                '<?php echo $row['pms_reference_product_itemname'] ; ?>',
                                                                '<?php echo $row['pms_order_quantity'] ; ?>',
                                                                '<?php echo $row['pms_unit'] ; ?>',
                                                                '<?php echo $row['pms_typeunit'] ; ?>',
                                                                '<?php echo $row['pms_unit_price'] ; ?>',    
                                                                '<?php echo $row['pms_product_item_name'] ; ?>');"
                                            href="#referenceProductModal<?php echo $row['pms_id'];?>"
                                            style="background-color: #3bdb39; color: #ffffff;"
                                            class="btn"><i class="icon-pencil icon-large"> Edit</i></button>
                                &nbsp;
                                <button onclick="archiveRefProd('<?php echo $row['pms_id'] ?>');"
                                        id="archiveBtn"
...
<div id="archiveRefProdModal" class="w3-modal">
        <div class="w3-modal-content" style="margin-top: -70px; margin-left: 100px; width: 1300px;">
            <div class="w3-container">
            <br>
            <center>
            <h4 class="modal-title"><span id="archiveRefProdModaltitle"></span></h4>
            </center>
            <br><br>
            <span onclick="document.getElementById('archiveRefProdModal').style.display='none'" class="w3-button w3-display-topright">&times;</span>
          ...
          $header_count = 0; 
          $sql = mysqli_query($GLOBALS["___mysqli_ston"], 
          "SELECT * FROM pms_referenceproducts WHERE pms_product_item_name = '$rp_pms_item' AND pms_archive_status = 1");
          while ($row=mysqli_fetch_array($sql)) {
              $header_count++;
          ?>
                                <tr>
...
<div id="referenceProductModal" class="w3-modal">
<div class="w3-modal-content" style="margin-top: -80px; margin-left: 350px; width: 700px; height: 800px;">
    <div class="w3-container">
      <br>
      <center>
      <h4 class="modal-title"><span id="referenceProductModaltitle"></span></h4>
      </center>
      <br><br>
      <span onclick="document.getElementById('referenceProductModal').style.display='none'" class="w3-button w3-display-topright">&times;</span>

      <form class="form-horizontal" method="post" enctype='multipart/form-data'>
      
            <input type="hidden" name="inputstatusrefproduct" id="inputstatusrefproduct">
            <input type="hidden" name="inputkeyrefproduct" id="inputkeyrefproduct">


             <center>
              <img src="images/uploadimage/noimage.png" id="refproductimagesource" alt="Walang Imahe" width="150px" height="150px" style="border-radius: 25px;">
             </center><br>

        <!-- <div class="form-group" id="pms_suprod_image" style="width: 850px;">
          <label class="control-label col-lg-3" for="price"> <span id="supplierImageTitle">RP Image</span></label>
          <div class="col-lg-9">
            <input type="file" onchange="readURL(this);" class="form-control input-focus" id="pms_image" name="pms_image">
          </div>
        </div> -->

        <input type="hidden" id="pms_image" name="pms_image">

        <div class="form-group" style="width: 850px;">
          <label class="control-label col-lg-3" for="price">Raw Material SKU</label>
          <div class="col-lg-9">
          <select class="form-control input-focus" id="pms_reference_product_itemname" name="pms_reference_product_itemname" onchange="itemProduct();">
                        ...
                        <option value="<?php echo $pms_raw_material_item; ?>"> <?php echo $pms_raw_material_item; ?> </option>
                        <?php } ?>
                    </select>
            <!-- <input type="text" class="form-control input-focus" value="<?php //echo $rp_pms_item; ?>" id="pms_reference_product_itemname" name="pms_reference_product_itemname" readonly> -->
          </div>
        </div>

        <div class="form-group" style="width: 850px;">
          <label class="control-label col-lg-3" for="price">Order Quantity</label>
          <div class="col-lg-9">
            <input type="number" class="form-control input-focus" id="pms_order_quantity" name="pms_order_quantity" placeholder="Enter your Order Quantity" required>
          </div>
        </div>
        ...
        <div class="form-group" style="width: 850px;">
          ...
          <div class="col-lg-9">
            ...
            <br>
            <input type="text" class="form-control input-focus" id="pms_typeunit" name="pms_typeunit" readonly>
          </div>
        </div>
        ...
        <div class="form-group" style="width: 850px;">
          ...
          <div class="col-lg-9">
            <input type="number" class="form-control input-focus" id="pms_unit_price" name="pms_unit_price" readonly>
          </div>
        </div>
              ...
              <center>
                <div style="text-align: center;">
                 ...
                 <!-- <button onclick="launch_toast()" id="saveBtn" type="submit" style="border-radius: 20px;" class="btn btn-lg btn-success"
                  ...
                  >Save</button>&nbsp;&nbsp;
                  <button id="cancelBtn" type="button" style="border-radius: 20px;" class="btn btn-lg btn-danger" onclick="document.getElementById('referenceProductModal').style.display='none'" class="btn btn-default" data-dismiss="modal">Cancel</button>
                </div>
              </center><br><br>
...
function itemProduct() {
    var selectBox = document.getElementById("pms_reference_product_itemname");
...
function FetchSupplier(name) {
    ...
    $(document).ready(function(){	
        $.ajax({
            url: 'http://localhost/PMS/8080/pms_get_raw_material_item.php?name=' + name,
            dataType: 'jsonp',
            jsonp: 'pms',
            timeout: 5000,
            success: function(data, status){
                $.each(data, function(i,item){ 
                    if (item.pms_id==undefined){
                        ...
                        // var rp_pms_reference_product_itemname = item.pms_reference_product_itemname ;
                        var rp_pms_unit = item.pms_unit;
                        var rp_pms_typeunit = item.pms_type_of_units ;
                        var rp_pms_unit_price = item.pms_cost;
                        var rp_pms_image = item.pms_image;

                        // if (rp_pms_image==undefined) {
                        //     var supplierimage_info = "" ;
                        // } else {
                        //     var supplierimage_info = rp_pms_image ;
                        // }

                        $('#refproductimagesource').attr('src', 'images/uploadimage/' + rp_pms_image);
                        $("#pms_unit").val(rp_pms_unit);
                        $("#pms_typeunit").val(rp_pms_typeunit);
                        $("#pms_unit_price").val(rp_pms_unit_price);
                        $("#pms_image").val(rp_pms_image);
                      }                  
                });
            },
            error: function(){
    ...
    function archiveRefProd(arch_pms_id)
    {
        document.getElementById('archiveModal').style.display='block';
        $("#archivestatus").val("archiverefprod") ;
    ...
    function confirmArchiveKey(confirmArchive_key)
    {
        ...
        document.getElementById('archiveRefProdModal').style.display='none';
        $("#archiverestorestatus").val("restorearchive") ;
        $("#archiverestorekey").val(confirmArchive_key) ;
    };

    function archiveListProdSup(){
        document.getElementById('archiveRefProdModal').style.display='block';
        $("#archiveRefProdModaltitle").html("ARCHIVES OF CUSTOMER") ;
    };
    ...
    function addReferenceProduct(){
          document.getElementById('referenceProductModal').style.display='block';

          $("#referenceProductModaltitle").html("Add New Reference Product(s)") ;
          $("#inputstatusrefproduct").val("addreferenceproduct") ;

        //   $('#pms_reference_product_itemname').prop('disabled', false);
        //   $('#pms_order_quantity').prop('disabled', false);
        //   $('#pms_unit').prop('disabled', false);
        //   $('#pms_unit_price').prop('disabled', false);
        //   $('#pms_reference_product_itemname').prop('disabled', false);

        //   $("#pms_reference_product_itemname").val("") ;
        //   $("#pms_order_quantity").val("") ;
        //   $("#pms_unit").val("") ;
        //   $("#pms_unit_price").val("") ;
        //   $("#pms_reference_product_itemname").val("") ;
          // $("#pms_suprod_suppliername").val() ;

          $('#pms_image').css('visibility','visible');
    ...
    function editreferenceproduct(key,image,reference_product_itemname,order_quantity,unit,typeunit,unitprice,product_item_name)
    {
          document.getElementById('referenceProductModal').style.display='block';
          $("#referenceProductModaltitle").html("Edit Reference Product of " + product_item_name) ;
          $("#inputstatusrefproduct").val("editreferenceproduct") ;
          $("#inputkeyrefproduct").val(key) ;

        //   $('#pms_suprod_itemname').prop('disabled', false);

          $('#refproductimagesource').attr('src', 'images/uploadimage/' + image);
          $("#pms_reference_product_itemname").val(reference_product_itemname) ;
          $("#pms_order_quantity").val(order_quantity) ;
          $("#pms_unit").val(unit) ;
          $("#pms_typeunit").val(typeunit) ;
          $("#pms_unit_price").val(unitprice) ;
          ...
          document.getElementById("refproductimagesource").src = i;
    };
    ...
    // };
     ...
     function viewSupProd(key,image,item,description,unit,typeunit,cost,suppliername)
    {
          document.getElementById('referenceProductModal').style.display='block';
          $("#referenceProductModaltitle").html("View Supplier Product") ;
        ...
        //   $('#pms_suprod_suppliername').prop('disabled', true);
