...
<div id="myDiv" class="animate-right">
            ...
            <div class="container-fluid">
                ...
                <!-- <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Transaction(s)</h3>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="card bg-dark p-20">
                            <div class="media widget-ten">
                                ...
                                <div class="media-body media-text-right">
                                    ...
                                    <p class="m-b-0">Job Order</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-dyellow p-20">
                            <div class="media widget-ten">
                                <div class="media-left meida media-middle">
                                ...
                                <div class="media-body media-text-right">
                                    <h2 class="color-white">278</h2>
                                    <p class="m-b-0">Sales Order</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-lgreen p-20">
                            <div class="media widget-ten">
                                <div class="media-left meida media-middle">
                                ...
                                <div class="media-body media-text-right">
                                    ...
                                    <p class="m-b-0">Purchase Order</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Production(s)</h3>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="card bg-primary p-20">
                            <div class="media widget-ten">
                                ...
                                <div class="media-body media-text-right">
                                    <h2 class="color-white">278</h2>
                                    <p class="m-b-0">Assemble Product(s)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-pink p-20">
                            <div class="media widget-ten">
                                ...
                                <div class="media-body media-text-right">
                                    <h2 class="color-white">278</h2>
                                    <p class="m-b-0">Finishing Product(s)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- <img data-u="image" src="../img/gallery/980x380/001.jpg" /> -->
                            <div>
                              <div style="background-color: rgba(0, 0, 0, 0.8); margin-top: 45px; width: 520px; height: 230px;"> <br>
                                ...
                                <img data-u="image" src="plugin/slider/img/gallery/samp_pms-1.jpg" />
                            </div>
                            <div>
                              <div style="background-color: rgba(0, 0, 0, 0.8); margin-top: 45px; width: 520px; height: 230px;"> <br>
                                <h1 style='padding-left: 10px; color: #FFF; font-weight: lighter; font-family: "Comic Sans MS", cursive, sans-serif;'>  We believe in what people make possible </h1>
                            ...
                            <div>
                                <img data-u="image" src="plugin/slider/img/gallery/samp_pms-3.jpg" />
                            </div>
                            <div>
                                <img data-u="image" src="plugin/slider/img/gallery/samp_pms-4.jpg" />
                            </div>
                            <div>
                                <img data-u="image" src="plugin/slider/img/gallery/samp_pms-5.jpg" />
                            </div>
                            <div>
                                <img data-u="image" src="plugin/slider/img/gallery/samp_pms-6.jpg" />
                            </div>
                            <div>
