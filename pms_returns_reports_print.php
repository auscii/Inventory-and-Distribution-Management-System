...
<html>
<head>
<title>Returns Report | Inventory and Distribution Management System</title>
        ...
        while ($rows=mysqli_fetch_array($sql)) {
            ...
            if ($print_pms_hid_temp!=$rows['pms_hid']) {
                ...
                '<hr><table>
                    ...
                    <tbody>
                        <tr>
                        <td> <strong>Returns #: </strong>'. $print_pms_hid . '</td>
                        <td> Due Date:  '. $print_pms_checkdate . '</td>
                        <td> Returns Date:  '. $print_pms_date . '</td>
                        ...
                        <td>Back Account #:  '. $print_pms_bankaccountno . '</td>
                        </tr>
                ...
                if ($print_pms_returns_temp!=$rows['pms_purchaseorder']) {
                    echo $report_detail ;
                }
                echo
                '<table>
                    ...
                    <tbody>
                        ...
                        <td colspan="2">'. $print_dp_total . '</td>
                        </tr>
                    </tbody>
                 </table>';
            ...
            $print_pms_returns_temp = $rows['pms_purchaseorder'] ;
