        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Returns Report</h3> </div>
...
function printReport()
{
    ...
    window.open('http://localhost/PMS/8080/pms_returns_reports_print.php?pms_date_from=' + print_datefrom + '&pms_date_to=' + print_dateto);
};
