  ...
  <center>
   ...
   <img src="images/pms_logo/pms_logo.jpg" height="133" width="161"><br><br><br>
    ...
    <table class="table">
                        ...
                        <?php
                            $countnum = 0;
                            $sql_fp_sku = "SELECT * FROM pms_rawmaterials WHERE pms_archive_status = 0 AND pms_finishedproduct = 0";
                            $sql_fp = mysqli_query($GLOBALS["___mysqli_ston"], $sql_fp_sku);
                            while ($rowzz=mysqli_fetch_array($sql_fp)) {
                            $countnum++;
                            $appr_pms_id = $rowzz['pms_id'];
                            $appr_pms_sku = $rowzz['pms_sku'];
                            $appr_pms_description = $rowzz['pms_description'];
                        ...
                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: #000; text-align: center;"><?php echo $appr_pms_sku; ?></td>
                                                <td style="color: #000; text-align: center;"><?php echo $appr_pms_description; ?></td>
