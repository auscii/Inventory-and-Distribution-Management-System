...
<head>
    ...
    <title>Return to Supplier(s) Report | Inventory and Distribution Management System</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Return to Supplier(s) Report</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Reports</a></li>
                        <li class="breadcrumb-item active">Return to Supplier(s) Report</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        ...
        <button
        class="btn" 
        onclick="window.location.href='pms_graph_return_supplier_report.php'"
        style="color:#fff;  height: 400px; width: 450px; border-radius: 50px; font-size: 50px;
