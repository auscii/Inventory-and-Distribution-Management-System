        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Purchase Order Report</h3> </div>
         ...
         <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <?php
                            $select_pms_date = "";
                            $sql_customer = "SELECT * FROM pms_purchaseorderheader";
...
function drawMonthwiseChart(chart_data, chart_main_title)
{
    ...
    data.addColumn('string', 'Supplier Name');
    data.addColumn('number', 'Purchase Order ID');
...
$(document).ready(function(){
    ...
    $('#year').change(function(){
        ...
        if(year != '')
        {
            load_monthwise_data(year, 'Purchase Order Report as of ');
        }
    });
