...
<head>
    ...
    <title>Stock Card | Inventory and Distribution Management System</title>
...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Stock Card</h3> </div>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <button
             onclick="javascript:window.location.href='pms_stockcard_reports_print_all.php'"
             class="btn"
             style="color:#fff;
                    background: #ba1307;
                    width: 250px;">
             <i class="fa fa-print"></i> PRINT STOCK CARD REPORT</button> <br> <br>
        ...
        <table id="DataTable1" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">PRODUCT ITEM</th>
                ...
                <tbody>
                  ...
                  ?>
                        ...
                        <td style="color: #000; text-align: center;"><?php echo $stock_count;?></td>

                        <td style="color: #000; text-align: center;"><?php echo $row_stock['pms_sku'];?></td>

                        <td style="color: #000; text-align: center;"><?php echo $row_stock['pms_in'];?></td>

                        <td style="color: #000; text-align: center;"><?php echo $row_stock['pms_out'];?></td>

                        <td style="color: #000; text-align: center;"><?php echo $row_stock['pms_transid'];?></td>

                        <td style="color: #000; text-align: center;"><?php echo $row_stock['pms_transtype'];?></td>

                        <td style="color: #000; text-align: center;"><?php echo $row_stock['pms_datetime'];?></td>
