...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Stock Card Report</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Transaction</a></li>
                        <li class="breadcrumb-item"><a href="pms_stock_card.php">Stock Card</a></li>
                        <li class="breadcrumb-item active">Stock Card Report</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
  ...
  <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="form-group" style="position: absolute; right: 0px; padding-right: 260px; margin-top: -79px;">
        ...
        <!-- <div class="form-group" style="position: absolute; right: 0px; margin-left: 650px; margin-top: -79px; ">
              <h3 class="control-label;">SKU (RM/FP)</h3>
                <div style="padding-right: 150px;" class="input-group">
                    <select class="form-control input-focus" id="pms_skurmfp" name="pms_skurmfp" style="width: 250px;">
                        <option value="" disabled selected>Select SKU(RM/FP)</option>
                        <?php
                            // $select_pms_sku = "";
                            // $sql_stockcard =
                            // "SELECT t1.pms_id AS pms_hid, t1.pms_sku, t1.pms_datetime, t1.pms_in,
                            //         t1.pms_out, t1.pms_transtype, t1.pms_transid, t1.pms_user,
                            //         t2.pms_id, t2.pms_sku AS rm_sku, t2.pms_item, t2.pms_description
                            // FROM pms_stockcard AS t1
                            // INNER JOIN pms_rawmaterials AS t2
                            // ON t1.pms_sku = t2.pms_id";
                            // $sql_c = mysqli_query($GLOBALS["___mysqli_ston"], $sql_stockcard);
                            // while ($row_s=mysqli_fetch_array($sql_c)) {
                            // $select_pms_sku = $row_s['pms_item'];
                        ?>
                        <option value="<?php echo $select_pms_sku; ?>"><?php echo $select_pms_sku; ?></option>
                        <?php //} ?>
                    </select>
                  </div>
				<input type="hidden" id="dtp_input2" value="" /><br/>
...
function printReport()
{
    ...
    // var print_skurmfp = document.getElementById("pms_skurmfp").value ;

    window.open('http://localhost/PMS/8080/pms_stockcard_reports_print.php?pms_date_from='
    + print_datefrom + '&pms_date_to=' + print_dateto);

    // window.open('http://localhost/PMS/8080/pms_stockcard_reports_print.php?pms_date_from='
    // + print_datefrom + '&pms_date_to=' + print_dateto + '&pms_skurmfp=' + print_skurmfp);
};
