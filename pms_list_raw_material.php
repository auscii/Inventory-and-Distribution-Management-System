          ...
          <div class="container-fluid">
              ...
              <div class="row">
                  ...
                  <h4 class="card-title">Save As</h4>
                      ...
                      <!--  <a href="print_raw_material_product.php" 
                    ...
                    <table id="DataTable1" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          ...
                          <?php
                          $sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM pms_rawmaterials WHERE pms_archive_status = 0 AND pms_finishedproduct = 0");
