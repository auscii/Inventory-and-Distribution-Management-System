...
<head>
    ...
    <title>Expired Products | Inventory and Distribution Management System</title>
      ...
      <div class="page-wrapper">
          ...
          <div class="row page-titles">
              <div class="col-md-5 align-self-center">
                  <h3 class="text-primary">Expired Products</h3> </div>
                    ...
                    <table id="DataTable1" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;">Assembly by</th>
                        ...
                        <tbody>
                          ...
                          ?>
                                ...
                                <!-- <td style="text-align: center; color: #000;"><?php //echo $count_num; ?></td> -->
                                
                                <td style="text-align: center; color: #000;"><?php echo $row['pms_expiration_date']; ?></td>

                                <td style="text-align: center; color: #000;"><?php echo $pms_item; ?></td>

                                <td style="text-align: center; color: #000;"><?php echo $row['pms_qty']; ?></td>

                                <td style="text-align: center; color: #000;"><?php echo $row['pms_assembleby']; ?></td>

                                <td style="text-align: center; color: #000;"><?php echo $row['pms_remarks']; ?></td>
